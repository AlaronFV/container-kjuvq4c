...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kjuvq4c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kjuvq4c.containers.anotherwebservice.com/
...
```
git clone git@github.com:AlaronFV/container-kjuvq4c.git
cd container-kjuvq4c
```
...
```
docker attach container-kjuvq4c
```
